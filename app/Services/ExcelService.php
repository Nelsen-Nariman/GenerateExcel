        ...
        if ($this->data['tipe_plan'] === 'X'){
            if ($this->data['tipe_klien'] === 'Tanpa Tanggungan Mandiri'){
                if ($this->data['plan'] === 'BRONZE I'){
                    $this->data['premi'] = 6701000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'BRONZE II'){
                    $this->data['premi'] = 5649000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'SILVER'){
                    $this->data['premi'] = 8004000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'GOLD'){
                    $this->data['premi'] = 15449000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'TITANIUM'){
                    $this->data['premi'] = 22897000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else{
                    $this->data['premi'] = 23113000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
            }
            else{
                if ($this->data['plan'] === 'BRONZE I'){
                    $this->data['premi'] = 5027000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'BRONZE II'){
                    $this->data['premi'] = 4521000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'SILVER'){
                    $this->data['premi'] = 6005000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'GOLD'){
                    $this->data['premi'] = 10044000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'TITANIUM'){
                    $this->data['premi'] = 14886000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else{
                    $this->data['premi'] = 15025000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
            }
        }
            ...
            if ($this->data['tipe_klien'] === 'Tanpa Tanggungan Mandiri'){
                if ($this->data['plan'] === 'BRONZE I'){
                    $this->data['premi'] = 6210000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'BRONZE II'){
                    $this->data['premi'] = 4904000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'SILVER'){
                    $this->data['premi'] = 7639000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'GOLD'){
                    $this->data['premi'] = 11679000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'TITANIUM'){
                    $this->data['premi'] = 16303000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
            }
            else{
                if ($this->data['plan'] === 'BRONZE I'){
                    $this->data['premi'] = 4659000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'BRONZE II'){
                    $this->data['premi'] = 3924000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'SILVER'){
                    $this->data['premi'] = 5729000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'GOLD'){
                    $this->data['premi'] = 7592000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
                else if ($this->data['plan'] === 'TITANIUM'){
                    $this->data['premi'] = 11124000;
                    $this->data['premi_tertanggung_tambahan'] = 0;
                }
            }
        }
